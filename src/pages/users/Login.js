...
const Login = () => {
  ...
  const user = useSelector(state => state?.users); //passing in callback functions to return state
  const { userAppErr, userServerErr, userLoading, userAuth } = user;//destructure of user
  ...
  useEffect(() => {
    if (userAuth) {
      history.push("/profile");// if login routed to profile page
    }
  }, [userAuth]);
        ...
        <div className="row align-items-center">
          <div className="col-12 col-lg-5 mb-5">
            <div>
              ...
              You're College Broke! Stop it! Eat that Ramen
              </h2>
            ...
            <div className="p-5 bg-light rounded text-center">
              ...
              <form onSubmit={formik.handleSubmit}>
                <input
                  ...
                  onChange={formik.handleChange("email")} //binding form input
                  onBlur={formik.handleBlur("email")} //when user moves cursor it will mention that field is required
